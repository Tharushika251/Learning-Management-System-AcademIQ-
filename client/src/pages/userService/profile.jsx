...
import HighScoreQuizList from '../../components/HighScore/HighScoreQuizList';
                    ...
                    <div className="mt-20 px-8 pb-8">
                        <div className="border-b border-gray-200 dark:border-slate-700 mb-6">
                            <nav className="flex space-x-8">
                                ...
                                { id: 'quiz-list', label: 'Quiz List', visible: formData.role === 'teacher' },
                                { id: 'student-quiz-list', label: 'Quiz List', visible: formData.role === 'student' },
                                { id: 'my-score', label: 'My Score', visible: formData.role === 'student' },
                                { id: 'leaderboard', label: 'Leader Board', visible: formData.role === 'student' || 'teacher'}
                        ...
                        <div>
                            ...
                            {activeTab === 'quiz-list' && (
                                selectedQuizId ? (
                                    <EditQuiz quizId={selectedQuizId} onBack={() => setSelectedQuizId(null)} />
                                ) : (
                                    <QuizList onSelectQuiz={(id) => setSelectedQuizId(id)} />
                                )
                            )}
                            {activeTab === 'student-quiz-list' && (
                                <StudentQuizList />
                            )}
                            {activeTab === 'my-score' && (
                                <MyScore />
